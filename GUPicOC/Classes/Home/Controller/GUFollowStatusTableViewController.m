//
//  GUFollowStatusTableViewController.m
//  GUPicOC
//
...
static NSString *const followStatusCellID = @"status";

@interface GUFollowStatusTableViewController ()

@property(nonatomic, strong) NSMutableArray<GUStatus *> *statuses;
@property(nonatomic, weak) UILabel *refreshLabel;
@property(nonatomic, copy) NSString *maxTime;
//@property(nonatomic, strong) GUHTTPSessionManager *manager;

@end

@implementation GUFollowStatusTableViewController

/*
- (GUHTTPSessionManager *)manager {
    if (!_manager) {
        _manager = [GUHTTPSessionManager manager];
    }
    return _manager;
}
*/
...
- (void)setupTableView {
    ...
    [self.tableView registerNib:[UINib nibWithNibName:NSStringFromClass([GUStatusCell class]) bundle:nil] forCellReuseIdentifier:followStatusCellID];
}
...
{
    GUStatusCell *cell = [tableView dequeueReusableCellWithIdentifier:followStatusCellID];
